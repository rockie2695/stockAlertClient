            ...
            {selectHistory.length !== 0
              ...
              <ResponsiveContainer width='100%' height={400}>
                <LineChart data={selectHistory} margin={{ top: 10, right: 25, bottom: 10, left: 0 }}>
                  ...
                  <XAxis dataKey="jsTime" tickFormatter={(unixTime) => moment(unixTime).format('HH:mm')} type='number' scale='time' domain={['dataMin', 'dataMax']}  interval={selectHistory[selectHistory.length-1].jsTime/*(selectHistory[selectHistory.length-1].jsTime-selectHistory[0].jsTime)*//5}/>
